...
> 프로미스가 어떻게 동작하는지 이해하기 위해 예제 코드를 살펴보겠습니다. 먼저 아래 코드는 간단한 ajax 통신 코드입니다.
...
> 위 내용들을 종합하여 간단한 프로미스 코드를 만들어보겠습니다. 
>
...
#### 5. 여러 개의 프로미스 연결하기 (Promise Chaining)
