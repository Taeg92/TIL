...
## [computed 속성](https://kr.vuejs.org/v2/guide/computed.html#computed-속성)
...
### # [기본 예제](https://kr.vuejs.org/v2/guide/computed.html#기본-예제)
...
![image-20200528212506443](assets/computed_1.png)
...
### # [computed 속성의 캐싱 vs 메소드](https://kr.vuejs.org/v2/guide/computed.html#computed-속성의-캐싱-vs-메소드)
...
### # [computed 속성의 setter 함수](https://kr.vuejs.org/v2/guide/computed.html#computed-속성의-setter-함수)
...
## [watch 속성](https://kr.vuejs.org/v2/guide/computed.html#watch-속성)
...
![image-20200528212753617](assets/computed_2.png)
...
`watch` 옵션 외에도 명령형 [vm.$watch API](https://kr.vuejs.org/v2/api/#vm-watch)를 사용할 수 있습니다.