# [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#네비게이션-가드)네비게이션 가드
...
**Params 또는 쿼리를 변경하면 네비게이션 가드가 실행되지 않습니다**. 단순히 [`$route` 객체를 감시](https://router.vuejs.org/kr/guide/essentials/dynamic-matching.html#reacting-to-params-changes)하고 그 변화에 반응하십시오. 또는 컴포넌트 가드의 `beforeRouteUpdate`를 사용하십시오

​       

### [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#전역-가드)전역 가드
...
- **`to: 라우트`**: 대상 [Route 객체](https://router.vuejs.org/kr/api/#the-route-object) 로 이동합니다.
...
### [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#global-resolve-guards)Global Resolve Guards
...
### [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#global-after-hooks)Global After Hooks
...
### [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#라우트-별-가드)라우트 별 가드
...
### [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#컴포넌트-내부-가드)컴포넌트 내부 가드
...
### [#](https://router.vuejs.org/kr/guide/advanced/navigation-guards.html#전체-네비게이션-시나리오)전체 네비게이션 시나리오
