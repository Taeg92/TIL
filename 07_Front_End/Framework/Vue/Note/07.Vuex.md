# [#](https://vuex.vuejs.org/kr/#vuex가-무엇인가요)Vuex가 무엇인가요?
...
### [#](https://vuex.vuejs.org/kr/#상태-관리-패턴-이란-무엇인가요)"상태 관리 패턴"이란 무엇인가요?
...
대화식으로 Vuex를 배우고 싶다면 [Scrimba](https://vuex.vuejs.org/kr/(https://scrimba.com/g/gvuex))의 Vuex 과정에 등록하십시오.

![vuex](https://vuex.vuejs.org/vuex.png)

### [#](https://vuex.vuejs.org/kr/#언제-사용해야-하나요)언제 사용해야 하나요?
